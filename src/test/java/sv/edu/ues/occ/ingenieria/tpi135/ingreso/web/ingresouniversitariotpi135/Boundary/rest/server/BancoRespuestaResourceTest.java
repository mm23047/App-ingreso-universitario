...
class BancoRespuestaResourceTest {
    ...
    @Mock private BancoRespuestaDAO dao;
    @InjectMocks private BancoRespuestaResource resource;

    private BancoRespuesta testRespuesta;

    @BeforeEach
    void setUp() {
        testRespuesta = new BancoRespuesta();
        testRespuesta.setTextoRespuesta("Respuesta de ejemplo");
    }

    @Test
    void findRange_ConParametrosValidos_Retorna200ConLista() {
        List<BancoRespuesta> lista = List.of(testRespuesta);
