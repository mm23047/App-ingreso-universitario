 ...
 * URL real: /resources/v1/inscripciones_prueba/{idInscripcion}/carreras
...
public class CarrerasElegidaResourceST extends AbstractResourceST {
    ...
    void findRange_PorInscripcion1_DebeRetornarSusCarreras() {
        Response response = get("inscripciones_prueba/" + ID_INSCRIPCION_1 + "/carreras");
    ...
    void findRange_InscripcionInexistente_DebeRetornar404() {
        ...
        Response response = get("inscripciones_prueba/" + idInexistente + "/carreras");
    ...
    void create_AgregarCarreraAInscripcion_DebeRetornar201() {
        ...
        Response response = post("inscripciones_prueba/" + ID_INSCRIPCION_2 + "/carreras", nueva);
    ...
    void create_SinCarrera_DebeRetornar400() {
        ...
        Response response = post("inscripciones_prueba/" + ID_INSCRIPCION_1 + "/carreras", invalida);
    ...
    void update_CambiarPrioridad_DebeRetornar200() {
        ...
        String pathInscripcion = "inscripciones_prueba/" + ID_INSCRIPCION_2 + "/carreras";
    ...
    void update_CarreraNoRegistrada_DebeRetornar404() {
        ...
        Response response = put("inscripciones_prueba/" + ID_INSCRIPCION_1 + "/carreras/" + ID_CARRERA_ARQ, payload);
    ...
    void delete_CarreraElegidaExistente_DebeRetornar204() {
        ...
        String pathInscripcion = "inscripciones_prueba/" + ID_INSCRIPCION_1 + "/carreras";
    ...
    void delete_CarreraNoRegistrada_DebeRetornar404() {
        ...
        Response response = delete("inscripciones_prueba/" + ID_INSCRIPCION_1 + "/carreras/" + ID_CARRERA_ARQ);
