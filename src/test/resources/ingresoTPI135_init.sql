...
INSERT INTO turnos_examen (id_turno, id_prueba, nombre_turno, fecha, hora_inicio, hora_fin) VALUES
    ('g1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'Turno Mañana',  '2026-04-15', '07:00', '10:00'),
    ('g1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', 'Turno Tarde',   '2026-04-15', '13:00', '16:00');

-- claves_examen
INSERT INTO claves_examen (id_clave, id_prueba, nombre_clave) VALUES
    ('h1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'Clave A'),
    ('h1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', 'Clave B');

-- inscripciones_prueba
INSERT INTO inscripciones_prueba (id_inscripcion, id_aspirante, id_prueba, estado) VALUES
    ('i1000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'INSCRITO'),
    ('i1000000-0000-0000-0000-000000000002', 'e1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', 'INSCRITO');

-- aulas_examen
INSERT INTO aulas_examen (id_aula, id_turno, id_aula_api, capacidad, cupos_ocupados, accesible_silla_ruedas) VALUES
    ('j1000000-0000-0000-0000-000000000001', 'g1000000-0000-0000-0000-000000000001', 'AULA-101', 40, 2, FALSE),
    ('j1000000-0000-0000-0000-000000000002', 'g1000000-0000-0000-0000-000000000002', 'AULA-201', 35, 0, TRUE);

-- opciones_respuesta
INSERT INTO opciones_respuesta (id_opcion, id_pregunta, texto_opcion, es_correcta) VALUES
    ('k1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', '3',  FALSE),
    ('k1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000001', '4',  TRUE),
    ('k1000000-0000-0000-0000-000000000003', 'f1000000-0000-0000-0000-000000000001', '5',  FALSE),
    ('k1000000-0000-0000-0000-000000000004', 'f1000000-0000-0000-0000-000000000002', '10', FALSE),
    ('k1000000-0000-0000-0000-000000000005', 'f1000000-0000-0000-0000-000000000002', '12', TRUE),
    ('k1000000-0000-0000-0000-000000000006', 'f1000000-0000-0000-0000-000000000002', '14', FALSE),
    ('k1000000-0000-0000-0000-000000000007', 'f1000000-0000-0000-0000-000000000003', '7',  FALSE),
    ('k1000000-0000-0000-0000-000000000008', 'f1000000-0000-0000-0000-000000000003', '8',  TRUE),
    ('k1000000-0000-0000-0000-000000000009', 'f1000000-0000-0000-0000-000000000004', '27', FALSE),
    ('k1000000-0000-0000-0000-000000000010', 'f1000000-0000-0000-0000-000000000004', '29', TRUE);

-- preguntas_por_clave
INSERT INTO preguntas_por_clave (id_clave, id_pregunta) VALUES
    ('h1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001'),
    ('h1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000002'),
    ('h1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000003'),
    ('h1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000004');

-- asignaciones_aula_pupitre
INSERT INTO asignaciones_aula_pupitre (id_asignacion, id_inscripcion, id_aula, pupitre) VALUES
    ('l1000000-0000-0000-0000-000000000001', 'i1000000-0000-0000-0000-000000000001', 'j1000000-0000-0000-0000-000000000001', 'A-01'),
    ('l1000000-0000-0000-0000-000000000002', 'i1000000-0000-0000-0000-000000000002', 'j1000000-0000-0000-0000-000000000001', 'A-02');

-- carreras_elegidas
INSERT INTO carreras_elegidas (id_inscripcion, id_carrera, prioridad) VALUES
    ('i1000000-0000-0000-0000-000000000001', 'ICS', 1),
    ('i1000000-0000-0000-0000-000000000001', 'ISI', 2),
    ('i1000000-0000-0000-0000-000000000002', 'ISI', 1),
    ('i1000000-0000-0000-0000-000000000002', 'ICC', 2);
...
INSERT INTO proceso_admision_aspirante (id_inscripcion, id_etapa_actual, estado, carrera_asignada) VALUES
    ('i1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'EN_PROCESO', NULL),
    ('i1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000001', 'EN_PROCESO', NULL);

-- examenes_realizados
INSERT INTO examenes_realizados (id_examen, id_asignacion, id_clave, puntaje_final, fecha_realizacion, id_etapa) VALUES
    ('m1000000-0000-0000-0000-000000000001', 'l1000000-0000-0000-0000-000000000001', 'h1000000-0000-0000-0000-000000000001', 8.50, '2026-04-15 09:00:00+00', 'c1000000-0000-0000-0000-000000000001'),
    ('m1000000-0000-0000-0000-000000000002', 'l1000000-0000-0000-0000-000000000002', 'h1000000-0000-0000-0000-000000000001', 7.00, '2026-04-15 09:15:00+00', 'c1000000-0000-0000-0000-000000000001');

-- respuestas_examen
INSERT INTO respuestas_examen (id_respuesta, id_examen, id_pregunta, id_opcion_seleccionada) VALUES
    ('n1000000-0000-0000-0000-000000000001', 'm1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000002'),
    ('n1000000-0000-0000-0000-000000000002', 'm1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000002', 'k1000000-0000-0000-0000-000000000005'),
    ('n1000000-0000-0000-0000-000000000003', 'm1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000002'),
    ('n1000000-0000-0000-0000-000000000004', 'm1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000002', 'k1000000-0000-0000-0000-000000000004');
